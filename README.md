...
||||||| parent of f3b65af (docs: update readme with intent)
=======
Simplifying https://github.com/megalithic/dotfiles nvim config to use https://github.com/nvim-lua/kickstart.nvim

> > > > > > > f3b65af (docs: update readme with intent)
